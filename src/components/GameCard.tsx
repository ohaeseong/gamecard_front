        ...
        {type === "maplestory" && (
          <div className="relative w-full h-full">
            <div
              ...
              style={{
                backgroundImage: `url(/images/cards/maple-card-${
                  mapleBgIndex + 1
                }.png)`,
              }}
            >
              <div
                className={classNames(
                  "h-10 w-full flex items-center justify-between bg-black text-white px-2 bg-opacity-70 text-sm font-semibold"
                )}
              >
                <span>메이플스토리</span>
                <Image
              ...
              <div
                className={classNames(
                  "h-80 flex justify-center text-white items-center px-4 flex-col"
                )}
              >
                <img
                  className="w-64 h-64"
                ...
                <div className="flex w-full justify-between px-1">
                  ...
                  <span className="font-bold text-sm">Lv - {data.level}</span>
                </div>
                <div className="flex w-full justify-between px-1 flex-wrap">
                  <span className="font-bold  text-sm">Job - {data.job}</span>
